                            ...
                            <ul class="nav-users push">
                                <li>
                                    <a href="be_pages_generic_profile.html">
                                        <img class="img-avatar" src="/codebase/media/avatars/avatar6.jpg" alt="">
                                ...
                                <li>
                                    <a href="be_pages_generic_profile.html">
                                        ...
                                        <i class="fa fa-circle text-success"></i> Scott Young
                ...
                <div class="sidebar-content">
                    ...
                    <div class="content-side content-side-full">
                        <ul class="nav-main">
                            ...
                            <li>
                                <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-lock"></i><span class="sidebar-mini-hide">Bank Soal</span></a>
                                <ul>
                                    <li>
                            ...
                            <li class="open">
                                <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-badge"></i><span class="sidebar-mini-hide">Pengerjaan Peserta</span></a>
                                <ul>
                                    <li class="open">
